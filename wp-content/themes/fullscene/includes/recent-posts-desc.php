...
<ul class="recent-posts block-bg">
	...
	<li <?php post_class('recent-post-wrap');?>>
		<h3 class="recent-title"><?php echo get_post_meta($post->ID, 'recentPostsLabel', TRUE); ?></h3>
    <?php echo wpautop( get_post_meta($post->ID, 'recentPostsDesc', TRUE) ); ?>
    <a class="recent-button" href="<?php echo get_post_meta($post->ID, 'recentPostsLink', TRUE); ?>"><?php _e('View all', 'premitheme'); ?></a>
	</li>
