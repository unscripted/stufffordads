...
<ul class="recent-work-row">
	...
	<li class="folio-item-desc block-bg">
    <h3 class="recent-title"><?php echo get_post_meta($post->ID, 'recentWorkLabel', TRUE); ?></h3>
    <?php echo wpautop( get_post_meta($post->ID, 'recentWorkDesc', TRUE) ); ?>
    <a class="recent-button" href="<?php echo get_post_meta($post->ID, 'recentWorkLink', TRUE); ?>"><?php _e('View all', 'premitheme'); ?></a>
  </li>
